pipeline {
    ...
    parameters {
        ...
        string(defaultValue: 'ssh://git.maple.maceroc.com/git/millegrilles_core', name: 'GIT_URL')
        string(defaultValue: 'registry.millegrilles.com:5000/millegrilles/core_rust', name: 'DOCKER_IMAGE')
    }
